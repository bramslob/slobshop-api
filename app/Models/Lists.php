...
class Lists extends BaseModel
{
    ...
    {
        $listsQuery = $this->db->prepare('SELECT id, identifier, name, checked, updated_at FROM lists WHERE checked = :checked ORDER BY updated_at DESC');
    ...
    {
        $listsQuery = $this->db->prepare('SELECT id, identifier, name, checked, updated_at FROM lists WHERE id = :list_id');
    ...
    {
        $listsQuery = $this->db->prepare('SELECT id, identifier, name, checked, updated_at FROM lists WHERE identifier = :identifier');
